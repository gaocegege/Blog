...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/select/socket.png' | relative_url }}" alt="socket" height="300" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/select/reactor.png' | relative_url }}" alt="reactor" height="300"  width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/select/loop.png' | relative_url }}" alt="loop" height="300" width="500">
