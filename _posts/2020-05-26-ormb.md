...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/workflow.png' | relative_url }}" height="200" width="200">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/state-of-art.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/new.png' | relative_url }}" height="250" width="250">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/ormb-gh.png' | relative_url }}" height="500" width="500">
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/harbor.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/infer.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/webhook.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/docker-pull.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ormb/ormb.png' | relative_url }}" height="500" width="500">
