...
<figure>
	<img src="{{ site.url }}/images/ormb/infer.png" height="400" width="400">
    <figcaption>利用下载的模型进行推理</figcaption>
</figure>

当算法工程师迭代了新版本的模型时，可以打包新的版本，利用 [ormb][] 拉取新的镜像后重新部署。除此之外，[ormb][] 也可以复用 Harbor 的诸多能力。比如，[ormb][] 可以支持在训练环境、模型生产环境等多个环境的镜像仓库之间进行模型的同步。我们也可以为模型配置 Webhooks，在模型的生命周期中添加自定义的处理逻辑。
...
<figure>
	<img src="{{ site.url }}/images/ormb/docker-pull.png" height="400" width="400">
...
<figure>
	<img src="{{ site.url }}/images/ormb/ormb.png" height="400" width="400">
