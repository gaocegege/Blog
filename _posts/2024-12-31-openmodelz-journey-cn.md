...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/modelz/arch.png' | relative_url }}" alt="Architecture" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/modelz/lb.png' | relative_url }}" alt="Autoscaling" height="500" width="700">
