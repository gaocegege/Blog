...
<figure>
	<img loading="lazy" decoding="async" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/OS-structure2.svg/800px-OS-structure2.svg.png" alt="Hybrid Kernel" height="800" width="800">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/unikernel/exokernel.png' | relative_url }}" alt="ExoKernel" height="500" width="500">
