...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/mc.jpg' | relative_url }}" alt="人生中第一个mod" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/ipad.jpg' | relative_url }}" alt="造轮子" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/ass.jpg' | relative_url }}" alt="Assassin" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/planner.png' | relative_url }}" alt="Minecraft Structure Planner操作页面" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/mcedit.png' | relative_url }}" alt="mcedit操作页面" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/mc/mineways.png' | relative_url }}" alt="mineways操作页面" height="400" width="400">
