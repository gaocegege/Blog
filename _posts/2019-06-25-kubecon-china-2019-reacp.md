...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/kubecon/knative.png' | relative_url }}" height="500" width="700">
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/kubecon/gpu.png' | relative_url }}" height="500" width="700">
</figure>
