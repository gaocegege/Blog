...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/cpp/abc1.png' | relative_url }}" alt="类图" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/cpp/abc2.png' | relative_url }}" alt="类图" height="500" width="500">
	<figcaption>类图</figcaption>
</figure>
