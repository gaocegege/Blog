...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/util.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/smmem.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/mem.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/compute.png' | relative_url }}" height="700" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/sched.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/antman/algo.png' | relative_url }}" height="500" width="500">
