...
2024.12.24: 本文部分评论可见 [Hacker News](https://news.ycombinator.com/item?id=39823512)
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/memusage.png' | relative_url }}" alt="pgvectors" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/binary-bench.avif' | relative_url }}" alt="pgvectors" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/ar.avif' | relative_url }}" alt="adaptive-retrieval" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/ar-bench.png' | relative_url }}" alt="bench" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/shortening-embedding.svg' | relative_url }}" alt="bench" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/first-pass.png' | relative_url }}" alt="bench" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/memusage.png' | relative_url }}" alt="memory" height="500" width="700">
    <figcaption>Memory Usage (1M vectors)</figcaption>
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/final-bench.png' | relative_url }}" alt="bench" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/binary-vector/table.png' | relative_url }}" alt="bench" height="700" width="700">
    <figcaption>Benchmark</figcaption>
</figure>
