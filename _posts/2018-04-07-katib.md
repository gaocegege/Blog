...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/katib/katib.png' | relative_url }}" height="500" width="500">
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/katib/katib.gif' | relative_url }}" height="836" width="836">
</figure>
