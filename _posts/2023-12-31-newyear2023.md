...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/2023-newyear/pgvectors.png' | relative_url }}" alt="pgvectors" height="500" width="700">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/2023-newyear/pd.png' | relative_url }}" alt="twitter" height="500" width="700">
</figure>
