...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ray/ray.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/ray/arch.png' | relative_url }}" height="500" width="500">
