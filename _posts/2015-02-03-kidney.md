...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/kidney/kidney.png' | relative_url }}" alt="美帝捐肾情况" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/kidney/2-way.jpg' | relative_url }}" alt="2-way exchange" height="500" width="500">
	<figcaption>2-way Exchange</figcaption>
</figure>

<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/kidney/3-way.jpg' | relative_url }}" alt="3-way exchange" height="500" width="500">
