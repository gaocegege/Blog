...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HTML-presentation/deck.JPG' | relative_url }}" alt="Deck.js Demo" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HTML-presentation/reveal.JPG' | relative_url }}" alt="Reveal.js Demo" height="500" width="500">
