...
<figure>
	<img src="{{ '/images/MCM/fig3.jpg' | relative_url }}" alt="戴帽子问题图片" height="500" width="500">
...
<figure>
	<img src="{{ '/images/MCM/class1.png' | relative_url }}" alt="class1" height="400" width="400">
...
<figure>
	<img src="{{ '/images/MCM/class2.png' | relative_url }}" alt="class2" height="400" width="400">
...
<figure>
	<img src="{{ '/images/MCM/class3.png' | relative_url }}" alt="class3" height="400" width="400">
...
<figure>
	<img src="{{ '/images/MCM/class4.png' | relative_url }}" alt="class4" height="400" width="400">
