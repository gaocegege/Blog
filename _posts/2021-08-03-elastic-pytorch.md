...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/elastic-pytorch/agent_diagram.jpeg' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/elastic-pytorch/etcd_rdzv_diagram.png' | relative_url }}" height="500" width="500">
    <figcaption>elastic agent</figcaption>
</figure>
