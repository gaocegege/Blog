...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/typical.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/withoutcdn.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/withcdn.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/nfs.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/haystack.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/needle.png' | relative_url }}" height="300" width="300">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/haystack/flow.png' | relative_url }}" height="300" width="300">
