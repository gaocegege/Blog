...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/elastic-training/allreduce.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/elastic-training/horovod.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/elastic-training/mpioperator.png' | relative_url }}" height="500" width="500">
