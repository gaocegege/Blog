...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/vector/text.png' | relative_url }}" height="400" width="800">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/vector/benchmark.png' | relative_url }}" height="400" width="800">
...
![](https://pbs.twimg.com/media/FF8KN7cXsBAGOLj.jpg){: loading="lazy" decoding="async" }

使用 Rust 重写 pgvector 能够让代码以更现代的方式组织，更容易扩展。Rust 的生态也非常丰富，[faiss](https://github.com/Enet4/faiss-rs) 等已经有了对应的 Rust binding。

<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/vector/pgvectors.png' | relative_url }}" height="400" width="800">
