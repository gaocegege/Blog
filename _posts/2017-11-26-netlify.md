...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/netlify/start.png' | relative_url }}" alt="在 Netlify 中启用功能" height="500" width="500">
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/netlify/netlify.png' | relative_url }}" alt="使用" height="500" width="500">
</figure>
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/netlify/github.png' | relative_url }}" alt="使用" height="500" width="500">
</figure>
