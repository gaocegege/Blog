...
<figure>
	<img loading="lazy" decoding="async" src="http://docplayer.net/docs-images/26/9385319/images/70-0.png" alt="Computer System Architecture" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="http://docplayer.net/docs-images/24/3269448/images/11-0.png" alt="Process and System VM" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/xen-kvm/process-vm.png' | relative_url }}" alt="Process VM" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/xen-kvm/vm-types.png' | relative_url }}" alt="Classic VM and Hosted VM" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/xen-kvm/spt.png' | relative_url }}" alt="Shadow Page Table(SPT)" height="400" width="400">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/xen-kvm/tlb.png' | relative_url }}" alt="地址翻译过程" height="400" width="400">
