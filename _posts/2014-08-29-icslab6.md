...
至于mdriver测试如下	`mdriver -V`
   ...
   ![Score](http://gaocegege.github.io/Blog/images/lab6/score.png){: loading="lazy" decoding="async" }

**92/100**

## 代码

我的代码在[这里](https://github.com/gaocegege/ICS-Labs/tree/master/lab6)，仅供参考哦
