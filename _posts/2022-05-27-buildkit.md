...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/buildkit/arch.png' | relative_url }}" height="500" width="500">
...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/buildkit/llb.png' | relative_url }}" height="500" width="500">
