...
<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HackShanghai/1.jpg' | relative_url }}" alt="铭牌" height="500" width="500">
	<figcaption>我的铭牌</figcaption>
</figure>

<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HackShanghai/2.jpg' | relative_url }}" alt="Computer" height="500" width="500">
	<figcaption>我的电脑与Leap Motion</figcaption>
</figure>

<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HackShanghai/3.jpg' | relative_url }}" alt="Computer" height="500" width="500">
	<figcaption>比赛现场</figcaption>
</figure>

<figure>
	<img loading="lazy" decoding="async" src="{{ '/images/HackShanghai/us.jpg' | relative_url }}" alt="us" height="500" width="500">
