...
<figure>
	<img src="/Blog/images/kubernetes/initial-state.png" alt="State" height="300" width="300">
</figure>

文字性的叙述过于单调，这里用图来说明这个过程。在图中一共有 16 台服务器，有着不同的配置。

<figure>
	<img src="/Blog/images/kubernetes/algorithm.png" alt="State" height="500" width="500">
</figure>
